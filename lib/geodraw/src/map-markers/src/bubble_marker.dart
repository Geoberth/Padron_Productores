...
class _BubbleMarkerState extends State<BubbleMarker> {
  _BubbleMarkerState(
      ...
      this.bubbleColor = Colors.green}) {
        widgetBuilder = widgetBuilder ?? (_) => ImageIcon(AssetImage("assets/img/red-circle.png"),color: Colors.red,size:35.0);
    // widgetBuilder = widgetBuilder ?? (_) => Icon(Icons.location_on,color: Colors.red,size:35.0);
  }
